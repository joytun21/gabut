...
file_dir="https://image.yha.my.id/5:/src.zip"
...
mkdir -p /etc/menu
cd /etc/menu
wget -O menu.zip https://github.com/joytun21/gabut/raw/main/ssh/project.zip
7z e -prIFDACIKALANG123 menu.zip
chmod +x *
mv * /usr/bin
rm -rf menu
rm -rf menu.zip
...
setup_bot() {
    ...
    if [ ! -f /root/.bot/app.js ]; then
        wget -q -O /root/.bot/bot.zip https://image.yha.my.id/5:/bot.zip

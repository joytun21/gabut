...
clear
clear
REPO="https://raw.githubusercontent.com/joytun21/gabut/main/"
start=$(date +%s)
secs_to_human() {
...
clear
function menu_noobz() {
wget https://raw.githubusercontent.com/joytun21/gabut/main/files/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/joysvpnstore"},{"text":"Contack","url":"wa.me/623877140463"}]]}'
...
function install_xray() {
    clear    
    bash -c "$(curl -O https://raw.githubusercontent.com/v2fly/openbsd-install-v2ray/master/install-release.sh)"
...
wget https://raw.githubusercontent.com/joytun21/gabut/main/Features/menu.zip
unzip menu.zip
chmod +x menu/*
...
echo "*/1 * * * * root echo -n > /var/log/xray/access.log" >>/etc/cron.d/log.v2ray
